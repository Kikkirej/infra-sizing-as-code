<template>
  <div class="edit-panel">
    ...
    <div class="field-group">
      ...
      <label>Prefix Text <textarea v-model="form.prefix_text" @blur="save" rows="2" /></label>
      <label>Suffix Text <textarea v-model="form.suffix_text" @blur="save" rows="2" /></label>
    </div>
  </div>
</template>
...
const form = reactive({ display_name: props.node.display_name, prefix_text: props.node.prefix_text || '', suffix_text: props.node.suffix_text || '' })
watch(() => props.node, (n) => Object.assign(form, { display_name: n.display_name, prefix_text: n.prefix_text, suffix_text: n.suffix_text }))
