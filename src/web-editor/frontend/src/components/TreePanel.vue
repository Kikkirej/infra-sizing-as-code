    ...
    <div v-else class="tree-root">
      ...
      >
        ...
        <template v-if="expanded[sn]">
          <!-- Adoc nodes -->
          <div class="tree-node adoc-node" :class="adocClass(product.preamble_change)" @click="selectAdoc(`infra/${sn}/preamble.adoc`, 'preamble')">
            ...
            <template v-if="expanded[sn+'/'+ssn]">
              <div v-for="(flavour, fsn) in size.flavours" :key="fsn" class="tree-node-group indent-2">
                ...
                <template v-if="expanded[sn+'/'+ssn+'/'+fsn]">
                  ...
                  <div class="tree-node adoc-node indent-3" :class="adocClass(flavour.preamble_change)"
                    @click="selectAdoc(`infra/${sn}/${ssn}/${fsn}/preamble.adoc`, 'preamble')">
                    <span class="node-label">preamble.adoc</span>
                  </div>
